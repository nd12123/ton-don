...
export default function CalculatorPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-black flex flex-col items-center px-4">
      ...
      <motion.section
        className="w-full max-w-xl bg-white rounded-2xl shadow-lg p-8 mt-10 border border-gray-200"
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <Button className="bg-blue-500 hover:bg-blue-600 w-full mt-4 text-white">
            Stake Now
          </Button>
        </div>
      </motion.section>
